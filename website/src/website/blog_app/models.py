...
class BlogPostQuerySet(models.QuerySet):
    ...
    def search(self, query):
        ...
        return self.filter(title__icontains=lookup)
...
class BlogPost(models.Model):
    ...
    slug    = models.SlugField(unique=True) # it's a URL encoded value -> hello world is hello-world
    ...
    class Meta:
        ordering = ['-published_date', '-updated', '-timestamp'] #- indicates the most recent
